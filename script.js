...
btnYes.addEventListener("click", function () {
    ...
    btnYes.addEventListener("click", function() {
        alert("Helu goodmorning again sleepyhead!! I hope you sleptwell. GOODLUCK IN YOUR ACADS TODAY AND KEEP THE GOODWORK!! Be gentle on yourself ahh and avoid being stressed. THANKYOUUU SO MUCHHHHIEEE AND HAVE A GOOD DAYYY, See youu laterrr <3          -Little Ghoul");
    });
});
