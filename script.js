...
btn.addEventListener("click", function () {
    if (btn.textContent === "Okay") {
        audio.play();
        text.textContent = "YOU are 17 and I am turning 18 next month, I kinda like those numbers. Do you agree with me? yes or yes?";
...
btnYes.addEventListener("click", function () {
    ...
    btnYes.addEventListener("click", function() {
        alert("Helu goodmorning again sleepyhead!! I hope you slept well. GOODLUCK IN YOUR ACADS TODAY AND KEEP THE GOODWORK!! You did better than you think today. Be gentle with yourself ahh and avoid stress. THANKYOUUUUU SO MUCHHHHIEEE AND HAVE A GOOD DAYYY, See youu laterrr <3                                                         -Little Ghoul");
    });
});
